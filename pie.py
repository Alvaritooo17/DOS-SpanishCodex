...
def login_checker(Usuario,Contraseña):
    file_path = os.path.join(os.path.dirname(__file__), 'login.txt')
    try:
        with open(file_path) as f:
            credentials = [x.strip() for x in f.readlines() if x.strip()]
            for x in credentials:
             c_Usuario, c_Contraseña = x.split('@')
             if c_Usuario.upper()  == Usuario.upper() and c_Contraseña.upper() == Contraseña.upper():
               return True
...
status_help_type = 0
def command():
    global status_help_type,status_code,prefix_get,Usuario,Contraseña,GUI_SETUP
    ...
    data_input_loader = input(f"{Fore.CYAN}{Usuario}{Fore.WHITE}@{Fore.BLUE}{Contraseña} {Fore.WHITE}${Fore.RESET}")
    args_get = data_input_loader.split(" ")
    if args_get[0].upper() == f"{prefix_get}CREDIT":
        print(f"{Fore.YELLOW}         __..---..__\n{Fore.YELLOW}     ,-='  {Fore.RED}/  |  \{Fore.YELLOW}  `=-.\n{Fore.LIGHTWHITE_EX}    :--..___________..--;\n{Fore.WHITE}     \.,_____________,./ \n{Fore.LIGHTYELLOW_EX}   ╔═╗╔═╗╔═╗╦╔═╔═╗╔╦╗{Fore.RED}┌─┐┬┌─┐\n{Fore.YELLOW}   ╚═╗║ ║║  ╠╩╗║╣  ║{Fore.LIGHTRED_EX} ├─┘│├┤ \n{Fore.LIGHTRED_EX}   ╚═╝╚═╝╚═╝╩ ╩╚═╝ ╩{Fore.WHITE}o{Fore.LIGHTYELLOW_EX}┴  ┴└─┘\n\n{Fore.LIGHTMAGENTA_EX}CREDIT {Fore.WHITE}- {Fore.LIGHTBLUE_EX}ART {Fore.WHITE}: {Fore.CYAN}Alvaritooo.17 {Fore.WHITE}- {Fore.LIGHTCYAN_EX}Spanish C0dex {Fore.WHITE}|{Fore.GREEN} DEV {Fore.WHITE}- {Fore.LIGHTGREEN_EX}github.com/Alvaritooo17{Fore.RESET}")
    elif args_get[0].upper() == f"{prefix_get}HELP":
        print(f"{Fore.GREEN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━┓\n┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┻━┫\n{Fore.LIGHTGREEN_EX}┃ MENU DE AYUDA                                      ┃\n{Fore.GREEN}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\n   {Fore.RED}{prefix_get}HELP         {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para enseñar el menu de ayuda\n   {Fore.RED}{prefix_get}CREDIT     {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para ver los Creditos\n   {Fore.RED}{prefix_get}CLS          {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para limpiar la pantalla\n   {Fore.RED}{prefix_get}MENU         {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para volver al selector\n   {Fore.RED}{prefix_get}GUI_SET      {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para cambiar el attack del gui\n   {Fore.RED}{prefix_get}PREFIX_SET   {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para añadir un prefix\n   {Fore.RED}{prefix_get}FLOOD        {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para atacar con el flood en hhtp\n   {Fore.RED}{prefix_get}PING_URL     {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para hacer un ping con url\n   {Fore.RED}{prefix_get}PING_TCP     {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para hacer un ping con tcp\n   {Fore.RED}{prefix_get}EXIT         {Fore.LIGHTGREEN_EX}┃ {Fore.YELLOW}Para cerrar el panel\n{Fore.GREEN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛{Fore.RESET}")
    elif args_get[0].upper() == f"{prefix_get}PREFIX_SET":
        if len(args_get) == 2:
            prefix_get = args_get[1]
            clear_text()
            print(f"{Fore.RED}   ██╗  ██╗██╗  ██╗██╗  ██╗ \n{Fore.LIGHTRED_EX}   ╚██╗██╔╝╚██╗██╔╝╚██╗██╔╝ \n{Fore.WHITE}    ╚███╔╝  ╚███╔╝  ╚███╔╝ \n{Fore.RED}    ██╔██╗  ██╔██╗  ██╔██╗ \n{Fore.LIGHTRED_EX}   ██╔╝ ██╗██╔╝ ██╗██╔╝ ██╗ \n{Fore.WHITE}   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ \n{Fore.RED} \n {Fore.WHITE}[{Fore.GREEN}+{Fore.WHITE}] {Fore.WHITE}< {Fore.LIGHTGREEN_EX}Escribe {prefix_get}HELP FOR SHOW COMMAND {Fore.WHITE}> {Fore.RESET}")
        else:
        ...
        clear_text()
        print(f"{Fore.LIGHTYELLOW_EX}         __..---..__\n{Fore.YELLOW}     ,-='  {Fore.RED}/  |  \{Fore.YELLOW}  `=-.\n{Fore.LIGHTWHITE_EX}    :--..___________..--;\n{Fore.WHITE}     \.,_____________,./ \n{Fore.RED}   ██╗  ██╗██╗  ██╗██╗  ██╗ \n{Fore.LIGHTRED_EX}   ╚██╗██╔╝╚██╗██╔╝╚██╗██╔╝ \n{Fore.WHITE}    ╚███╔╝  ╚███╔╝  ╚███╔╝ \n{Fore.RED}    ██╔██╗  ██╔██╗  ██╔██╗ \n{Fore.LIGHTRED_EX}   ██╔╝ ██╗██╔╝ ██╗██╔╝ ██╗ \n{Fore.WHITE}   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ \n{Fore.RED} \n {Fore.WHITE}[{Fore.GREEN}+{Fore.WHITE}] {Fore.WHITE}< {Fore.LIGHTGREEN_EX}Escribe {prefix_get}HELP para ver los comandos {Fore.WHITE}> {Fore.RESET}")
...
def checker_login():
    ...
    clear_text()
    print(f"{Fore.LIGHTYELLOW_EX}         __..---..__\n{Fore.YELLOW}     ,-='  {Fore.RED}/  |  \{Fore.YELLOW}  `=-.\n{Fore.LIGHTWHITE_EX}    :--..___________..--;\n{Fore.WHITE}     \.,_____________,./ \n{Fore.RED}   ██╗  ██╗██╗  ██╗██╗  ██╗ \n{Fore.LIGHTRED_EX}   ╚██╗██╔╝╚██╗██╔╝╚██╗██╔╝ \n{Fore.WHITE}    ╚███╔╝  ╚███╔╝  ╚███╔╝ \n{Fore.RED}    ██╔██╗  ██╔██╗  ██╔██╗ \n{Fore.LIGHTRED_EX}   ██╔╝ ██╗██╔╝ ██╗██╔╝ ██╗ \n{Fore.WHITE}   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ \n{Fore.RED} \n {Fore.WHITE}[{Fore.GREEN}+{Fore.WHITE}] {Fore.WHITE}< {Fore.LIGHTGREEN_EX}Escribe {prefix_get}HELP para ver los comandos {Fore.WHITE}> {Fore.RESET}")
    print(f"{Fore.YELLOW}USER - ROOT {Fore.LIGHTYELLOW_EX}Contraseña - ROOT{Fore.RESET}")
    time.sleep(0.5)
    Usuario = input(f"{Fore.CYAN}USUARIO {Fore.WHITE}${Fore.RESET}")
    time.sleep(0.5)
    Contraseña = input(f"{Fore.BLUE}Contraseña {Fore.WHITE}${Fore.RESET}")
    time.sleep(0.5)
    print(F"{Fore.BLUE}LOGIN TO PANEL {Fore.WHITE}({Fore.LIGHTBLUE_EX}TRYING LOGIN WITH {Usuario}@{Contraseña}{Fore.WHITE}) . . .{Fore.RESET}")
    time.sleep(int(random.randint(1,3)))
    if login_checker(Usuario,Contraseña) == True:
     print(f"{Fore.CYAN}PANEL LOADING . . .{Fore.RESET}")
     time.sleep(1)
     clear_text()
     command()
    elif login_checker(Usuario,Contraseña) == 'UNKNOWN ERROR ARE RETURNING BY FILESNOTFOUND':
